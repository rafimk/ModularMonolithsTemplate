...
namespace CompanyName.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260816164915_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyName.Common.Infrastructure.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CompanyName.Common.Infrastructure.Inbox.InboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("CompanyName.Common.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CompanyName.Common.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("CompanyName.Modules.Users.Domain.Users.Permission", b =>
                {
            ...
            modelBuilder.Entity("CompanyName.Modules.Users.Domain.Users.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("CompanyName.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("CompanyName.Modules.Users.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("CompanyName.Modules.Users.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("CompanyName.Modules.Users.Domain.Users.User", null)
                        .WithMany()
